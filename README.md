...
- **Interactive Web App**: Clean and responsive UI using HTML, CSS, Bootstrap, and JavaScript.
- **Fast Inference**: Uses preprocessed data serialized with Pickle for fast recommendation generation.
